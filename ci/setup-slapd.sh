...
cp $curdir/rfc2307bis.ldif /etc/ldap/schema/
...
ldapadd -H ldapi:// -D cn=admin,dc=plug,dc=org,dc=au -w plug -f $curdir/basic-structure.ldif
ldapadd -H ldapi:// -D cn=admin,dc=plug,dc=org,dc=au -w plug -f $curdir/specialgroups.ldif

# Add example users
ldapadd -H ldapi:// -D cn=admin,dc=plug,dc=org,dc=au -w plug -f $curdir/user-chair.ldif
ldapadd -H ldapi:// -D cn=admin,dc=plug,dc=org,dc=au -w plug -f $curdir/user-bob.ldif
